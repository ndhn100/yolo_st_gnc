...
# Bổ sung A.4.1: khảo sát hệ thống cụ thể.
...
# Thêm xử lý giám sát hạn chế sau B.4.3.
...
# Bổ sung nguồn trực tiếp cho các sản phẩm đã khảo sát.
